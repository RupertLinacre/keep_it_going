...
Each effect lasts **20 seconds of active game time**. Pausing freezes the timer. Effects do not stack or replace one another early. After expiry there is a three-second breather, then the next gate is placed 28–58 route metres ahead, searching for rail with a moderate slope. The first gate starts 65 metres ahead. The shuffled bag includes all six effects before refilling and avoids identical consecutive effects at bag boundaries.
